...
# --- Shared nav + styles ---
NAV_CSS = """
.nav{display:flex;align-items:center;padding:12px 24px;max-width:100%;margin:0 auto;position:relative}.nav .logo{flex:1;text-align:center}.nav-links{position:absolute;right:24px;display:flex;gap:20px;align-items:center}
