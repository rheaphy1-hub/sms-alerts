...
.sign-preview{max-width:300px;margin:8px auto 24px;padding:0 24px;text-align:center}.sign-preview img{width:100%;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,0.08);border:1px solid #e0e0dc}.sign-caption{font-size:13px;color:#888;margin-top:10px;font-style:italic}@media(max-width:600px){.filter-grid{grid-template-columns:1fr}.places-grid{grid-template-columns:repeat(2,1fr)}.sign-preview{max-width:240px}}
</style></head><body>
""" + NAV_HTML + """
<div class="hero">
...
<p class="sign-caption">This is what we send you the moment you sign up.</p>
</div>
...
<div class="cmd"><code>OK</code><span>Mark the issue handled</span></div>
